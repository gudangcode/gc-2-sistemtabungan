...
<head>
  ...
  <title>Sistem Informasi Pintar Menabung</title>
    ...
    <div class="login_wrapper">
      <div class="animate form login_form">
        <section class="login_content">
          <img src="build/images/ann.png" width="39%">
          <h2 style="font-size: 25px; font-weight: 600;color: #26b99a;">SIPITUNG</h2>
          <h2 style="font-size: 18px; font-weight: 200; color: #26b99a;">Sistem Informasi Pintar Menabung</h2>
      ...
      <p>Copyright © 2021 gudangCode .All rights reserved.</p>
    </div>
  </div>
  </section>
  </div>
